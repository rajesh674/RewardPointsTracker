...
export function calculateResults(incomingData) {
  ...
  const { byCustomer, totalPointsByCustomer } = pointsPerTransaction.reduce((acc, { custid, customerName, month, points, amount }) => {
    ...
    totalPointsByCustomer[customerName] = totalPointsByCustomer[customerName] || { customerName: customerName, points: 0, amount: 0 };
