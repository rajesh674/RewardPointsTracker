...
const calculatePointsByAmount = (amount) => {
    if (typeof amount !== 'number' || amount < 0) {
      ...
      if (amount > RewardThresholdAmount.OVER_100) {
        ...
        points += (RewardThresholdAmount.OVER_100 * 2) + (1 * RewardThresholdAmount.BETWEEN_50_AND_100);
      }
      if (amount > RewardThresholdAmount.BETWEEN_50_AND_100 && amount <= RewardThresholdAmount.OVER_100) {
