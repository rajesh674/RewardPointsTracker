...
const ErrorPage = () => {
    return (
        <Stack sx={styleObj} spacing={2}> {/* Stack component with custom style and spacing */}
            <Alert sx={{ width: '1200px' }} severity="error"> {/* Alert component with custom width and error severity */}
                <AlertTitle>Error</AlertTitle> {/* AlertTitle component with the title 'Error' */}
                <> {/* Fragment to group multiple elements */}
                    <h1>404 - Page Not Found</h1> {/* Heading displaying the error message */}
                    <p>Sorry, the page you are looking for could not be found.</p> {/* Paragraph with error explanation */}
                </>
            </Alert>
        </Stack>
    );
